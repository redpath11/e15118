/* Set binning parameters for histograms made in PreGeant.C */
   /* "best case" 
   ...
   */
   /* "best case" + 1 MeV 
   Int_t nbinsx = 100; Double_t x1=-50; Double_t x2=50;
   Int_t nbinsy = 100; Double_t y1=-50; Double_t y2=50;
   Int_t nbinske= 100; Double_t ke1=45.,ke2=85.;
   Int_t nbinsv = 60; Double_t v1 =9.0,v2=12.0;
   Int_t nbinsvr= 150; Double_t vr1=-1.5,vr2=1.5;
   Int_t nbinst = 60; Double_t t1 = 28;Double_t t2 = 34;
   */

   /* "best case" + MoNA resolutions 
   Int_t nbinsx = 100; Double_t x1=-5; Double_t x2=5;
   Int_t nbinsy = 100; Double_t y1=-5; Double_t y2=5;
   Int_t nbinske= 100; Double_t ke1=54.,ke2=64.;
   Int_t nbinsv = 75; Double_t v1 =10.,v2=10.75;
   Int_t nbinsvr= 100; Double_t vr1=-0.5,vr2=0.5;
   Int_t nbinst = 100; Double_t t1 = 20;Double_t t2 = 40;
   */
   /* "best case" + ALL resolutions 
   Int_t nbinsx = 100; Double_t x1=-5; Double_t x2=5;
   Int_t nbinsy = 100; Double_t y1=-5; Double_t y2=5;
   Int_t nbinske= 100; Double_t ke1=50.,ke2=70.;
   Int_t nbinsv = 100; Double_t v1 =9.5,v2=11.;
   Int_t nbinsvr= 100; Double_t vr1=-0.5,vr2=0.5;
   Int_t nbinst = 100; Double_t t1 = 20;Double_t t2 = 40;
   */
   /* "best case" + 1 MeV + ALL resolutions */
   Int_t nbinsx = 150; Double_t x1=-150; Double_t x2=150;
   Int_t nbinsy = 150; Double_t y1=-150; Double_t y2=150;
   Int_t nbinske= 100; Double_t ke1=45.,ke2=85.;
   Int_t nbinsv = 60; Double_t v1 =9.0,v2=12.;
   Int_t nbinsvr= 200; Double_t vr1=-2.0,vr2=2.0;
   Int_t nbinst = 100; Double_t t1 = 20;Double_t t2 = 40;
